                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text">$</span>
                                                            <input type="number" step="0.01" name="sale_price" id="sale_price" class="form-control" readonly>
                                                        </div>
...
function populateDiscountFromSalePrice() {
    const price = parseFloat(document.getElementById('price').value) || 0;
...
document.getElementById('generateVariations')?.addEventListener('click', () => {
    ...
    if (attrs.length === 0) {
        document.getElementById('variationsTable').innerHTML = '<p class="text-muted">Add attributes above and click Generate</p>';
        return;
    }
        ...
        html += `<tr>
            <td><small>${name}</small>
                ${Object.entries(attrs).map(([k,val]) => 
                    `<input type="hidden" name="variations[${i}][attributes][${k}]" value="${val}">`).join('')}
            </td>
